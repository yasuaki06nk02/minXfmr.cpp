...
// Allocate a float matrix without using the transient arena allocator.
// Use for long-lived tensors (e.g. model weights) that must survive
// tensor_arena_reset() across generation calls.
