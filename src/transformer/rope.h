...
void rope_apply(Tensor* tensor, size_t start_pos, size_t n_heads, size_t head_dim, size_t n_rot = 0, float theta = 10000.0f);
...
void apply_inplace(float* q, float* k, int head_dim, int pos, int n_rot = 0, float theta = 10000.0f);
